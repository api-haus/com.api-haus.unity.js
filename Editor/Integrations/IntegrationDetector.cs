...
namespace UnityJS.Integrations.Editor
{
  ...
  static class IntegrationDetector
  {
    static readonly (string guid, string define, string rspRelPath)[] s_integrations =
    {
      ...
      ("75469ad4d38634e559750d17036d5f7c", "UNITY_JS_INPUT_SYSTEM", "Integrations/InputSystem/csc.rsp"),
      ("de4e6084e6d474788bb8c799d6b461ec", "UNITY_JS_ALINE", "Integrations/ALINE/csc.rsp"),
      ("fba13774ff4078041871f6741c062151", "UNITY_JS_CHARACTER_CONTROLLER", "Integrations/CharacterController/csc.rsp"),
      ("fb24642277b1db2449da7ac148ce939d", "UNITY_JS_QUANTUM_CONSOLE", "Integrations/QuantumConsole/csc.rsp"),
    };

    static IntegrationDetector()
    {
      var pkgInfo = UnityEditor.PackageManager.PackageInfo.FindForAssembly(typeof(IntegrationDetector).Assembly);
