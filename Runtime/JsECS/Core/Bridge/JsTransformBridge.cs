namespace UnityJS.Entities.Core
{
  ...
  static partial class JsECSBridge
  {
    ...
    static unsafe void Transform_GetPosition(
      JSContext ctx,
      long thisU,
      long thisTag,
      int argc,
    ...
    [MonoPInvokeCallback(typeof(QJSShimCallback))]
    static unsafe void Transform_SetPosition(
      JSContext ctx,
      long thisU,
      long thisTag,
      int argc,
    ...
    [MonoPInvokeCallback(typeof(QJSShimCallback))]
    static unsafe void Transform_GetRotation(
      JSContext ctx,
      long thisU,
      long thisTag,
      int argc,
    ...
    [MonoPInvokeCallback(typeof(QJSShimCallback))]
    static unsafe void Transform_MoveToward(
      JSContext ctx,
      long thisU,
      long thisTag,
      int argc,
