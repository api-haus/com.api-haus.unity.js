namespace UnityJS.Entities.Core
{
  ...
  public static class JsScriptPathUtility
  {
    ...
    public static string ScriptsFolderAbsolute => JsScriptSearchPaths.DefaultScriptsPath;
    ...
    public static string GetScriptFilePath(string scriptId)
    {
      ...
      var fileName = relativePath + JS_EXTENSION;

      return JsScriptSearchPaths.GetScriptPath(fileName);
    }
    ...
    public static bool ScriptExists(string scriptId)
    {
      ...
      return JsScriptSearchPaths.ScriptExists(fileName);
    }
    ...
    )
    {
      ...
      return JsScriptSearchPaths.TryFindScript(fileName, out foundPath, out searchedBasePath);
    }
