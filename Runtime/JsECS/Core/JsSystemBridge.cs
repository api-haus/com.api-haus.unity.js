namespace UnityJS.Entities.Core
{
	...
	public static class JsSystemBridge
	{
		...
		static unsafe void System_DeltaTime(JSContext ctx, long thisU, long thisTag,
		...
		[MonoPInvokeCallback(typeof(QJSShimCallback))]
		static unsafe void System_Time(JSContext ctx, long thisU, long thisTag,
			int argc, JSValue* argv, long* outU, long* outTag)
		{
		...
		[MonoPInvokeCallback(typeof(QJSShimCallback))]
		static unsafe void System_Random(JSContext ctx, long thisU, long thisTag,
			int argc, JSValue* argv, long* outU, long* outTag)
		{
			float min = 0, max = 1;
			if (argc >= 2)
		...
		[MonoPInvokeCallback(typeof(QJSShimCallback))]
		static unsafe void System_RandomInt(JSContext ctx, long thisU, long thisTag,
			int argc, JSValue* argv, long* outU, long* outTag)
		{
			int min = 0, max = 1;
			if (argc >= 2)
