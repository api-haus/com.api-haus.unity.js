namespace UnityJS.Entities.Tests
{
	...
	/// <summary>
	/// Port of LuaEntityRegistryTest for JsEntityRegistry.
	/// Tests bidirectional lookup, pending state, version safety, cache consistency.
	/// Requires PlayMode (World.DefaultGameObjectInjectionWorld).
	/// </summary>
	[Ignore("Requires PlayMode — World.DefaultGameObjectInjectionWorld is null in EditMode")]
	public class JsEntityRegistryTests
	{
		World m_World;
