namespace UnityJS.Entities.Tests
{
	...
	public unsafe class JsVmRecreationTests
	{
		...
		static int ReadGlobalInt(string name)
		{
			...
			if (vm == null || !vm.IsValid) return -1;
			...
			{
				var val = QJS.JS_Eval(vm.Context, pSrc, src.Length - 1, pFile,
		...
		public void VmInstance_ChangesAcrossSessions()
		{
			...
			Assert.IsNull(JsRuntimeManager.Instance,
				"VM should be null after world dispose");
